...
module.exports = function(bot, config) {
    ...
    slack_api.callAPI = function(command, data, cb, multipart) {
        ...
        bot.debug('** callAPI Command ' + command + ' multipart? ' + multipart);
		bot.debug('** callAPI data ' + command, data);
    ...
    function postForm(url, formData, cb, multipart) {
        ...
        if (multipart === true) {
			bot.log('** Multipart ', formData);
            params.formData = formData;
        } else {
			bot.log('** NO Multipart ', formData);
		...
		bot.log('** Params ', params);

        request.post(params, function(error, response, body) {
            bot.debug('44444-Got response', error, body);
